  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-gradient-to-b from-[#1a1a1a] to-black rounded-3xl border border-white/10 shadow-2xl overflow-hidden relative">
      ...
      <div className="p-6 md:p-10 relative z-10">
        <h3 className="text-xl md:text-3xl font-bold text-white mb-2 uppercase text-center">Prémium Árkalkulátor</h3>
        <p className="text-gray-400 text-center mb-8 md:mb-10 text-sm">Állítsd össze a csomagodat a pontos becsléshez</p>
            ...
            <div className="mt-8 pt-6 border-t border-gray-800">
              <div className="flex justify-between items-end mb-6">
                ...
                <motion.div
                  ...
                  className="text-3xl md:text-4xl font-bold text-white text-right"
                >
